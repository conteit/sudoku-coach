...
export const en = {
  ...
  'claim.digit': 'Which digit are you following?',
  ...
  'claim.prompt.chain': 'Tap the chain in order. Each link is a house where only two cells can still take the {digit}.',
  'claim.check': 'Check',
  ...
  'claim.verdict.chainProves': 'That colouring holds, and it clears the {digit} from {count} cells.',
  'claim.verdict.chainProvesOne': 'That colouring holds, and it clears the {digit} from one cell.',
