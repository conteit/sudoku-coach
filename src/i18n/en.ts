...
export const en = {
  ...
  'coach.notesBlocked': 'I cannot go on your notes just yet — the check finds a candidate missing that nothing rules out, and reading marks with a hole in them can prove things that are not true. Run the note check and I will pick up from there.',
  ...
  'coach.whatIsThis': 'Lesson',
  'coach.another': 'Show another',
  'coach.anotherShort': 'Another',
  'coach.putAway': 'Take it from here',
  'savePoint.pin': 'Pin this board',
  'savePoint.replace': 'Update pin',
  'savePoint.back': 'Back to the pinned board',
  'savePoint.backShort': 'Back to pin',
  'savePoint.caption': 'go back',
  'settings.tab.about': 'About',
  'about.build': 'This build',
  'about.buildExplainer': 'Date, hour and commit of the build you are running. Paste it into a bug report — it is how we know which app you were looking at.',
  'about.check': 'Check for updates',
  'about.checking': 'Looking\u2026',
  'about.current': 'You are on the latest build.',
  'about.found': 'A newer build is on its way — the app will reload itself.',
  'about.unavailable': 'Updates cannot be checked here — this browser is not running the offline worker.',
  'about.failed': 'Could not reach the server. Try again when you are back online.',
  ...
  // Claiming a technique: the player naming a pattern instead of asking for
  // one. `prompt.*` is one per claim shape, `verdict.*` one per outcome — the
  // enum-shaped families the dictionary already uses for `exercise.*`.
  'claim.open': 'I\u2019ve spotted something',
  ...
  'claim.check': 'Check',
  'claim.roles.wing': '{pivot} is the hinge; {wings} are the arms.',
  'claim.clears': 'It takes the digit off {count} cells.',
  'claim.clearsOne': 'It takes the digit off one cell.',
  'claim.apply': 'Clear those notes',
  'claim.applied': 'Cleared. Undo puts them back.',
  'claim.cancel': 'Never mind',
  'claim.retry': 'Try again',
  'claim.done': 'Done',
  'claim.askCoach': 'Ask the coach instead',
  'claim.verdict.holds': 'Yes — that holds, on {digit}.',
  'claim.verdict.holdsPlain': 'Yes — that holds.',
  'claim.verdict.no': 'That is not one of those.',
  'claim.verdict.chainProves': 'That colouring holds on {digits}, and it clears {count} marks.',
  'claim.verdict.chainProvesOne': 'That colouring holds on {digits}, and it clears one mark.',
  'claim.verdict.chainBarren': 'That chain holds — but nothing follows from it yet.',
  'claim.verdict.chainBroken': 'Your chain breaks at the link marked on the board.',
  ...
  'exercise.start': 'Practise this technique',
  'exercise.startOpen': 'Mixed practice',
  'exercise.openIntro': 'A grid where some technique applies, without being told which one.',
  'exercise.openTitle': 'Mixed practice',
  'exercise.untracked': 'Practice grids are made on the spot and thrown away. Nothing here is saved, timed or counted.',
  'exercise.building': 'Building a grid\u2026',
  'exercise.unavailable': 'No grid to practise this on turned up. Worth another try — the patterns that are rare on a board are rare to generate too.',
  'exercise.retry': 'Try again',
  'exercise.newGrid': 'New grid',
  ...
  'exercise.namingHelp': 'Every mark is already in. Read the grid, then name the pattern you can see.',
  'exercise.prompt.cell': 'Point at the cell this step is about.',
  'exercise.prompt.pattern': 'Point at the {count} cells that form the pattern.',
  'exercise.prompt.corners': 'Point at the {count} corners of the pattern.',
  'exercise.prompt.pivot': 'Point at the hinge — the cell the pattern turns on.',
  'exercise.prompt.wings': 'Now the {count} arms.',
  'exercise.prompt.chain': 'Point at the {count} cells of the chain.',
  'exercise.prompt.eliminations': 'Now take off the {count} notes this pattern rules out.',
  'exercise.prompt.placement': 'Now enter the digit this step proves.',
  'exercise.solved': 'Solved. That is the whole step.',

  'exercise.feedback.roleWrong': 'Not that cell. Look again at what this part of the pattern has to do.',
  'exercise.feedback.techniqueWrong': 'That pattern is not on this grid.',
  'exercise.feedback.notProved': 'This pattern does not rule that note out.',
  'exercise.feedback.notPlaced': 'This step does not put a digit there.',
  ...
  'sync.toast.gamesOne': 'A game was updated from another device.',
  'sync.toast.games': '{count} games were updated from another device.',
