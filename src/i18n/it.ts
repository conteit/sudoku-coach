...
export const it: Dictionary = {
  ...
  'claim.digit': 'Quale cifra stai seguendo?',
  'claim.prompt.set': 'Tocca le celle dello schema.',
  'claim.prompt.wing': 'Tocca le tre celle. Non devi dire quale sia il perno.',
  'claim.prompt.chain': 'Tocca la catena in ordine. Ogni anello è una zona in cui solo due celle possono ancora prendere il {digit}.',
  ...
  'claim.verdict.chainProves': 'La colorazione regge, e toglie il {digit} da {count} celle.',
  'claim.verdict.chainProvesOne': 'La colorazione regge, e toglie il {digit} da una cella.',
