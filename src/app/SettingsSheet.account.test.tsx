...
describe('the account section', () => {
  it('offers sign-in, and says it is optional in the same breath', () => {
    renderSettings();
  ...
  it('is absent entirely from a build with no Firebase config', () => {
  ...
  it('names who is signed in, and offers the way out', () => {
  ...
  it('reports a failed attempt as a line, not a dialog', () => {
